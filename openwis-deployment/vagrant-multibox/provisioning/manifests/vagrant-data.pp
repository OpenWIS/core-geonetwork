...
file {"/home/vagrant/bin/configure-jboss":
    ensure => link,
    target => "${scripts_dir}/configure-jboss.sh"
}
file {"/home/vagrant/bin/deploy-dataservices":
    ensure => link,
    target => "${scripts_dir}/deploy-dataservices.sh"
}
file {"/home/vagrant/bin/deploy-managementservices":
    ensure => link,
    target => "${scripts_dir}/deploy-managementservices.sh"
}
